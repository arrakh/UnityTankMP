    ...
    public class GameManager : MonoBehaviour
    {
        ...
        protected void Update()
        {
            ...
            else if (this.state == State.RoundEnding)
            {
                ...
                if (this.stateCountDown <= 0.0f)
                {
                    this.SetGameRound(this.GetCurrentRound() + 1);
                }
            }
        ...
        protected void SetGameRound(int round)
        {
